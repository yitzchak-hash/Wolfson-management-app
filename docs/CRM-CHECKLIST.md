...
- ☑ The Drive folder's TITLE is kept on the job (driveFolderName) and searched by the header search, the job list and the search tile; the sweep backfills it for every linked job it sees (2026-09-08)
