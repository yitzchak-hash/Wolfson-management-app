      ...
      return (
        <Card label="Where everything is">
          <div className="h-full flex flex-col gap-3">
            ...
            <div className="flex-1 min-h-0 overflow-hidden grid gap-1.5 content-start">
...
function WorkspaceCard({ el, c }: { el: CanvasElement; c: WidgetCtx }) {
  ...
  return (
    <div className="w-full h-full flex flex-col px-3.5 py-3 overflow-hidden"
      ...
      <div className="flex-1 min-h-0 mt-2.5 grid gap-[3px] content-start overflow-hidden"
...
function WallClock() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center px-3.5 py-3">
      <div className="font-black leading-none tabular-nums text-slate-800" style={{ fontSize: 52 }}>
